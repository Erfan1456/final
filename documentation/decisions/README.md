...
* [ADR-009-authentication-application-flow.md](ADR-009-authentication-application-flow.md) — accepted authentication application service, thin Dart Frog routes, public customer/cleaner signup, generic login failures, dummy-hash missing-user verify, transparent rehash, refresh account-status checks, and idempotent logout.
